...
import { Stethoscope, Syringe, AlertCircle, LogOut } from "lucide-react"
...
const items = [
  ...
  {
    title: "Vacunas",
    url: "/veterinario/vacunas",
    icon: Syringe,
  },
  {
    title: "Enfermedades",
    url: "/veterinario/enfermedades",
    icon: AlertCircle,
  },
]

export function VeterinarioSidebar() {
      ...
      <SidebarHeader className="h-16 shrink-0 items-center border-b border-sidebar-border px-6 flex-row">
        <div className="flex items-center gap-2">
          <div className="flex flex-col">
            ...
            <span className="text-xs text-sidebar-foreground/70">Veterinario</span>
          </div>
        </div>
      </SidebarHeader>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton
                    ...
                    isActive={
                      ...
                      (item.url !== "/veterinario" && location.pathname.startsWith(item.url))
                    }
                    tooltip={item.title}
