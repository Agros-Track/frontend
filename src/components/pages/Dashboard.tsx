...
import { mockAnimals, mockAlerts, mockProductionData, mockWeightData } from "../../mock/mockData"
import { Link } from "react-router"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "../ui/tabs"
import { GrafanaDashboard } from "../ui/grafana-dashboard"
import { GRAFANA_DASHBOARDS } from "../../config/grafana.config"

export function Dashboard() {
  const [timezone, setTimezone] = useState("UTC-5")
  // Get user role from localStorage or context (adjust according to your auth implementation)
  ...
  return (
    <div className="space-y-8">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-8">{/* Status Summary */}
      ...
      <Card className="p-6 shadow-sm border border-border/50 bg-card">
        ...
        <TabsContent value="grafana" className="space-y-4">
          <GrafanaDashboard
            title={userRole === 'VETERINARIAN' ? GRAFANA_DASHBOARDS.VETERINARIAN.title : GRAFANA_DASHBOARDS.ADMIN.title}
            url={userRole === 'VETERINARIAN' ? GRAFANA_DASHBOARDS.VETERINARIAN.url : GRAFANA_DASHBOARDS.ADMIN.url}
            height="800px"
          />
        </TabsContent>
      </Tabs>
