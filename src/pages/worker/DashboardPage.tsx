...
import { CheckCircle2, Circle, Clock, AlertTriangle, Calendar, ClipboardList, Bell, Milk, Utensils, Scale, Plus, MapPin, Syringe, BarChart3, Activity } from "lucide-react";
    ...
    return (
        <div className="space-y-8">
            ...
            <Tabs defaultValue="overview" className="space-y-6">
                ...
                <TabsContent value="overview" className="space-y-8">{/* KPI Summary */}
                                        ...
                                        <div key={task.id} className="group flex flex-col sm:flex-row items-start sm:items-center p-4 px-6 hover:bg-muted/5 transition-colors gap-4">
                                            ...
                                            {task.status === 'pending' && (
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                                    className="h-8 px-4 text-xs border-[var(--green-dark)] text-[var(--green-dark)] hover:bg-[var(--green-dark)] hover:text-white transition-all shadow-sm font-medium"
                                                >
                                                    Completar
                                                </Button>
                                            )}
                ...
                <TabsContent value="grafana" className="space-y-4">
                    <GrafanaDashboard
                        title={GRAFANA_DASHBOARDS.WORKER.title}
                        url={GRAFANA_DASHBOARDS.WORKER.url}
                        height="800px"
                    />
                </TabsContent>
            </Tabs>
