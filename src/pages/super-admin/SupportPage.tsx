...
export function SupportPage() {
    ...
    const handleImpersonate = (tenant: string) => {
        toast.info(`Iniciando sesión como Administrador de ${tenant}...`);
        // Mock impersonation logic
        setTimeout(() => {
            toast.success(`Sesión suplantada exitosamente en ${tenant}`);
        }, 1000);
    };
                    ...
                    <Card key={ticket.id}>
                        ...
                        <CardContent>
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button size="sm" className="w-full" onClick={() => handleImpersonate(ticket.tenant)}>
